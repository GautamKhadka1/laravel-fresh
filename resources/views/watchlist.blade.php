...
@if (isset($carById) && $carById)
    @php $cars = $carById; @endphp
@elseif (function_exists('getWatchlist'))
    @php $cars = getWatchlist(); @endphp
@endif
        ...
        <div class="car-item card">
          ...
          <div class="p-medium">
            <div class="flex items-center justify-between">
              <small class="m-0 text-muted">{{$car->location??'Patan Dhoka'}}</small>
