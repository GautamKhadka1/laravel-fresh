...
<html lang="en">
  <head>
    ...
    {{-- asset  is global method that returns abs path of public directory  --}}
  <script src="{{asset('js/app.js')}}"></script>
    </head>
  <body>
    <header class="navbar">
      <div class="container navbar-content">
        <a href="/demo" class="logo-wrapper">
          <img src="{{ asset('storage/img/logoipsum-265.svg') }}" alt="Logo" />
        </a>
        ...
        <div class="navbar-auth">
          <a href="{{route('addNew')}}" class="btn btn-add-new-car">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
          ...
          <div class="navbar-menu" tabindex="-1">
            ...
            <ul class="submenu">
              ...
              <li>
                <a href="{{ route('watchList') }}">My Favourite Cars</a>
              </li>
              <li>
          ...
          <a href="{{route('loginRoute')}}}" class="btn btn-login flex items-center">
            <svg
